/*
Шаг 5. DDL для витрины: dwh.customer_report_datamart
*/
...
CREATE TABLE IF NOT EXISTS dwh.customer_report_datamart (
    ...
    platform_money NUMERIC(15,2) NOT NULL, -- сумма, которую заработала платформа от покупок заказчика за месяц
                                    -- (10% от суммы, которую потратил заказчик)
    ...
    top_craftsman_id BIGINT NOT NULL, -- идентификатор самого популярного мастера ручной работы у заказчика. Если заказчик  
                                      -- сделал одинаковое количество заказов у нескольких мастеров, возьмите любого
